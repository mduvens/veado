class Character {
    ...
    setDirection(controls) {
        ...
        var jump = new THREE.Vector3(0,10,0);
    ...
    rotate() {
        'use strict';
        // Set the direction's angle, and the difference between it and our Object 3D
    ...
    move() {
        ...
        this.mesh.position.x += this.direction.x * ((this.direction.z === 0) ? 4 :
            Math.sqrt(8));
        this.mesh.position.z += this.direction.z * ((this.direction.x === 0) ? 4 :
            Math.sqrt(8));
